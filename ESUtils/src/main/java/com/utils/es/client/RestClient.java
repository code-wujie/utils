...
public class RestClient implements Closeable {
    ...
    private final AbstractHttpAsyncClient client;
    ...
    RestClient(AbstractHttpAsyncClient client, long maxRetryTimeoutMillis, Header[] defaultHeaders,
    ...
    public synchronized void setHosts(HttpHost... hosts) {
        ...
        Set<HttpHost> httpHosts = new HashSet<HttpHost>();
    ...
    private void setHeaders(HttpRequest httpRequest, Header[] requestHeaders) {
        ...
        final Set<String> requestNames = new HashSet<String>(requestHeaders.length);
    ...
    public void close() throws IOException {
        try {
            ...
            LOGGER.error("es client shutdown error!");
